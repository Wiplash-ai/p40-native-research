#!/usr/bin/env python3
"""Client for the guarded T28 groupwise W4A8 real-Qwen shadow canary."""
...
RUN_COMMAND = "p40-t28-qwen-groupwise-shadow"
RESULTS_COMMAND = "p40-t28-qwen-groupwise-shadow-results"

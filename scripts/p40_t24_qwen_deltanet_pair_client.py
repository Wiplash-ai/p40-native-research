#!/usr/bin/env python3
"""Client for the fixed T24 64-token exact-Q8 DeltaNet pair comparison."""
...
RUN_COMMAND = "p40-t24-qwen-deltanet-pair"
RESULTS_COMMAND = "p40-t24-qwen-deltanet-pair-results"

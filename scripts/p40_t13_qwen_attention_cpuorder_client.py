#!/usr/bin/env python3
"""Client for the fixed T13 exact-Q8 attention 64-output comparison."""
...
RUN_COMMAND = "p40-t13-qwen-attention-cpuorder"
RESULTS_COMMAND = "p40-t13-qwen-attention-cpuorder-results"

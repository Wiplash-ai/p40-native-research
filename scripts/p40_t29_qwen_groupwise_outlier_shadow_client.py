#!/usr/bin/env python3
"""Client for the guarded T29 groupwise W4A8 outlier shadow canary."""
...
RUN_COMMAND = "p40-t29-qwen-groupwise-outlier-shadow"
RESULTS_COMMAND = "p40-t29-qwen-groupwise-outlier-shadow-results"

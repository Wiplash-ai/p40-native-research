#!/usr/bin/env python3
"""Client for the fixed T14 exact-Q8 shared-expert control."""
...
RUN_COMMAND = "p40-t14-shared-expert-cpuorder"
RESULTS_COMMAND = "p40-t14-shared-expert-cpuorder-results"
...
def main() -> int:
    ...
    try:
        completed = subprocess.run(
            ...
            text=True, capture_output=True, timeout=30 if args.read_results else 900,
        )

#!/usr/bin/env python3
"""Client for the fixed T16 exact-Q8 shared-MLP 64-output Qwen test."""
...
RUN_COMMAND = "p40-t16-qwen-shared-cpuorder"
RESULTS_COMMAND = "p40-t16-qwen-shared-cpuorder-results"

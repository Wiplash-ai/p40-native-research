#!/usr/bin/env python3
"""Client for the fixed T12 exact-Q8 attention Qwen canary."""
...
RUN_COMMAND = "p40-t12-qwen-attention-cpuorder"
RESULTS_COMMAND = "p40-t12-qwen-attention-cpuorder-results"

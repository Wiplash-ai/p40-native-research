#!/usr/bin/env python3
"""Client for the fixed T11 attention projection exact-Q8 control."""
...
RUN_COMMAND = "p40-t11-attention-cpuorder"
RESULTS_COMMAND = "p40-t11-attention-cpuorder-results"

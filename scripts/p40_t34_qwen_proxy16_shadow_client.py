#!/usr/bin/env python3
"""Client for the guarded T34 real-Qwen proxy16 shadow canary."""
...
RUN_COMMAND = "p40-t34-qwen-w4a8-proxy16-shadow"
RESULTS_COMMAND = "p40-t34-qwen-w4a8-proxy16-shadow-results"

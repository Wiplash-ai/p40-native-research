#!/usr/bin/env python3
"""Client for the fixed T10 64-output Qwen LM-head comparison."""
...
RUN_COMMAND = "p40-t10-qwen-lmhead-cpuorder"
RESULTS_COMMAND = "p40-t10-qwen-lmhead-cpuorder-results"

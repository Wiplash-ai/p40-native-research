#!/usr/bin/env python3
"""Client for the guarded T27 exact-Qwen attention profile."""
...
RUN_COMMAND = "p40-t27-qwen-attention-profile"
RESULTS_COMMAND = "p40-t27-qwen-attention-profile-results"

#!/usr/bin/env python3
"""Client for the guarded T30 groupwise W4A8 top-32 shadow canary."""
...
RUN_COMMAND = "p40-t30-qwen-groupwise-outlier32-shadow"
RESULTS_COMMAND = "p40-t30-qwen-groupwise-outlier32-shadow-results"

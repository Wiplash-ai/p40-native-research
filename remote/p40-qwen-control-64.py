#!/usr/bin/env python3
"""A separately forced, fixed 64-output Qwen thermal/control profile.

It reuses the audited narrow executor without adding request-controlled model,
environment, GPU, prompt, output length, or timing fields. The root-owned
installation and a distinct restricted key make this a separate server action
from the 16-output canary.
"""
...
OUTPUT_TOKENS = 64
EXPECTED_ORIGINAL_COMMAND = "p40-qwen-control-64"
RESULTS_ORIGINAL_COMMAND = "p40-qwen-control-64-results"
PROFILE_ID = "control-64"
SCHEMA_VERSION = "p40-qwen-control-64-v1"
RESULT_DIRECTORY = Path("/home/jordanculver/p40-native-research/results/qwen-controls-64")
